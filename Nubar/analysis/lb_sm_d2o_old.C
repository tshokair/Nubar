 ...
 */
{
	...
	TH1F * h8= new TH1F("h8","",400,400,900);
	TH1F * h9= new TH1F("h9","Acceptance Ratios ",400,400,900);
	TH1F * h10= new TH1F("h10","Acceptance Ratios ",400,400,900);
