 ...
 */
{
	...
	Float_t timeWindow=0.500;
	Float_t distanceWindow=700;
	...
	TH1F * h8= new TH1F("h8","",400,400,800);
	TH1F * h9= new TH1F("h9","Acceptance Ratios ",400,400,800);
	TH1F * h10= new TH1F("h10","Acceptance Ratios ",400,400,800);
	TH1F * h11= new TH1F("h11","time",300,0,3);
	TH1F * h12= new TH1F("h12","DeltaR of Any Coincidence",2400,0,1200);
	TH1F * h13= new TH1F("h13","Time Differences D2O",300,0,.5);
	TH1F * h14= new TH1F("h14","1-3 Time Differences",300,0,.5);
	TH1F * h15= new TH1F("h15","2-3 Time Differences",300,0,.5);
	h6->SetLineColor(5);
	h7->SetLineColor(6);
	h8->SetLineColor(9);
	h8->SetLineWidth(3);
